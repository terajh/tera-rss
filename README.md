...
8개 소스에서 10개 피드를 수집합니다. 국내 게임 웹진과 해외 게임/애니 매체를 포괄합니다.

#### 국내 (5개)

| ID | 소스 | 피드 수 | 포커스 |
|----|------|---------|--------|
| `ruliweb` | 루리웹 | 2 | 전체 뉴스, PC/온라인 |
| `gamedonga` | 게임동아 | 2 | 뉴스, 리뷰 |
| `gameshot` | 게임샷 | 1 | 게임 기사 |
| `yna` | 연합뉴스 | 1 | 문화/애니/엔터 |
| `inven` | 인벤 | 1 | 게임+애니 웹진 |
...
| ID | 소스 | 피드 수 | 포커스 |
|----|------|---------|--------|
| `pcgamer` | PC Gamer | 1 | PC 게임 |
| `ign` | IGN | 1 | 게임+애니 |
| `ann` | Anime News Network | 1 | 애니 뉴스 |
